...
- 実行日時: 2026-09-25 00:32:42 〜 2026-09-25 00:33:08 (run_id=26)
- 収集結果: 成功ソース 12 / 失敗ソース 5 / 新規 49件 / 更新 1944件
...
- **[High] [KEV] CVE-2026-71362: Adobe Commerce and Magento Incorrect Authorization Vulnerability ** (Japan Risk Score: 55, ステータス: NEW, CVE: CVE-2026-71362)
  - 情報源: CISA Known Exploited Vulnerabilities Catalog — https://nvd.nist.gov/vuln/detail/CVE-2026-71362
- **[High] [KEV] CVE-2026-5430: WSO2 Multiple Products Path Traversal Vulnerability ** (Japan Risk Score: 35, ステータス: NEW, CVE: CVE-2026-5430)
  - 情報源: CISA Known Exploited Vulnerabilities Catalog — https://nvd.nist.gov/vuln/detail/CVE-2026-5430
- **[High] Streamlink: HTTPSession follows HTTP redirects into file:// URLs, reading local files** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-92164)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-vf2x-4v53-pm7v
- **[High] Dozzle label filters do not restrict container event and statistics streams** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-62286)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-xcw9-qmmf-vqxj
- **[High] Decepticon: Role-boundary forgery via ChatML special-token literals in web crawl output composed into LLM context** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-61732)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-g5f9-3xfg-p9mf
- **[High] phpMyFAQ has Stored XSS in Admin FAQ Editor via HTML Entity Bypass in Frontend FAQ Submission** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-56736)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-pgwp-vc7q-cvj3
- **[High] @rsdoctor/rspack-plugin has Unauthenticated HTTP API that Exposes Project Source Code and Build Metadata** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-61782)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-jmg2-rcxh-w8q3
- **[High] Cline: Cross-Origin WebSocket Hijacking in Cline Hub Dashboard (`/browser` endpoint)** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-59723)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-3cj3-hqcr-g934
- **[High] CVE-2022-3324** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2022-3324)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2022-3324
- **[High] CVE-2022-3297** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2022-3297)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2022-3297
- **[High] CVE-2022-3296** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2022-3296)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2022-3296
- **[High] CVE-2022-3256** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2022-3256)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2022-3256
- **[High] CVE-2022-3134** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2022-3134)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2022-3134
- **[High] CVE-2022-3037** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2022-3037)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2022-3037
- **[Medium] CVE-2012-1637** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2012-1637)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2012-1637
- **[Low] phpMyFAQ's two-factor authentication login bypasses the password factor** (Japan Risk Score: 20, ステータス: NEW, CVE: CVE-2026-56737)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-8gpw-xvpf-hvx5
- **[Low] CrowdStrike Named a Leader in The Forrester Wave&trade;: Proactive Security Platforms, Q3 2026** (Japan Risk Score: 0, ステータス: NEW, CVE: -)
  - 情報源: CrowdStrike Blog — https://www.crowdstrike.com/en-us/blog/crowdstrike-named-leader-forrester-wave-proactive-security-platforms-q3-2026/
- **[Low] REDAXO: Unwhitelisted ORDER BY Column in rex_list Allows Authenticated Column Enumeration** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2026-62998)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-4f5f-j737-pm58
- **[Low] SunEditor: Critical XSS vulnerability - sanitizer bypass** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2026-59167)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-6rf4-v2fh-m6p4
- **[Low] podman quadlet install --replace does not fully replace the old file** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2026-19730)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-fx76-2j3w-2mx6

(他 29 件、ダッシュボードで確認してください)
...
- **[Critical] CVE-2000-0947** (Japan Risk Score: 0, ステータス: ACTIVE, CVE: CVE-2000-0947)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2000-0947

(他 1810 件、ダッシュボードで確認してください)
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-26r5-4mm2-px5c
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-4f5f-j737-pm58
- GitHub Security Advisories: https://github.com/advisories/GHSA-4hq8-gpf5-8p68
- GitHub Security Advisories: https://github.com/advisories/GHSA-5426-92w4-wvhv
- GitHub Security Advisories: https://github.com/advisories/GHSA-6rf4-v2fh-m6p4
- GitHub Security Advisories: https://github.com/advisories/GHSA-6v3r-4p5c-mrp5
- GitHub Security Advisories: https://github.com/advisories/GHSA-7c7c-373r-gfjj
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-9643-4qgh-g8mx
- GitHub Security Advisories: https://github.com/advisories/GHSA-9993-rfwp-rhwf
- GitHub Security Advisories: https://github.com/advisories/GHSA-9rg8-2wvr-fgjh
- GitHub Security Advisories: https://github.com/advisories/GHSA-9wh6-9hq7-9688
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-fx76-2j3w-2mx6
- GitHub Security Advisories: https://github.com/advisories/GHSA-g5f9-3xfg-p9mf
- GitHub Security Advisories: https://github.com/advisories/GHSA-gvf2-2rh5-mpgf
- GitHub Security Advisories: https://github.com/advisories/GHSA-hxcx-9h4f-42xx
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-vf2x-4v53-pm7v
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-wmw4-mw6x-6vfm
...
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2002-20001
...
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2012-5825
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2017-7200
...
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2021-20327
...
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2022-3037
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2022-3134
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2022-3256
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2022-3296
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2022-3297
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2022-3324
