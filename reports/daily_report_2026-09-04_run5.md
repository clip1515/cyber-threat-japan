...
- 実行日時: 2026-09-04 23:46:53 〜 2026-09-04 23:47:12 (run_id=5)
- 収集結果: 成功ソース 12 / 失敗ソース 5 / 新規 39件 / 更新 1923件
...
- **[Critical] CVE-2024-28056** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2024-28056)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2024-28056
- **[Critical] CVE-2019-3773** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2019-3773)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2019-3773
- **[High] [KEV] CVE-2026-85046: Google Chromium V8 Type Confusion Vulnerability** (Japan Risk Score: 55, ステータス: NEW, CVE: CVE-2026-85046)
  - 情報源: CISA Known Exploited Vulnerabilities Catalog — https://nvd.nist.gov/vuln/detail/CVE-2026-85046
- **[High] CodeWhale: image_analyze follows workspace symlinks, leaking external file bytes** (Japan Risk Score: 30, ステータス: NEW, CVE: CVE-2026-75914)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-w7wx-5q49-r59w
- **[High] CodeWhale: js_execution leaks parent environment to model context via missing env scrub** (Japan Risk Score: 30, ステータス: NEW, CVE: CVE-2026-75915)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-h539-c7r8-3xq4
- **[High] CVE-2024-5971** (Japan Risk Score: 20, ステータス: NEW, CVE: CVE-2024-5971)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2024-5971
- **[High] CodeWhale: Project config `instructions` override enables arbitrary file read into AI system prompt via cloned repository** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-75859)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-62f5-cp2p-vq95
- **[High] CodeWhale: Project config `allow_shell` override enables arbitrary shell command execution via cloned repository** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-75911)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-gx45-xrj5-g6c4
- **[High] CVE-2024-3884** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2024-3884)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2024-3884
- **[High] CVE-2025-9784** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2025-9784)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2025-9784
- **[High] CVE-2025-1244** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2025-1244)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2025-1244
- **[High] CVE-2024-7837** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2024-7837)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2024-7837
- **[High] CVE-2023-34062** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2023-34062)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2023-34062
- **[High] CVE-2020-5403** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2020-5403)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2020-5403
- **[High] CVE-2019-11284** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2019-11284)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2019-11284
- **[Medium] CVE-2023-34054** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2023-34054)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2023-34054
- **[Medium] CVE-2022-31684** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2022-31684)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2022-31684
- **[Medium] CVE-2020-5404** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2020-5404)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2020-5404
- **[Low] vLLM: Derender endpoints decode caller-supplied GenerateResponse token IDs without output bounds** (Japan Risk Score: 20, ステータス: NEW, CVE: CVE-2026-71486)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-8737-qx52-hjff
- **[Low] SurrealDB allows bypass of deny-net flags via DNS resolution** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2025-71390)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-m3c3-78fh-w3w7

(他 19 件、ダッシュボードで確認してください)
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-34fj-mwm6-fjfg
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-48jh-3gj7-fg8v
- GitHub Security Advisories: https://github.com/advisories/GHSA-5fhr-f75j-8wr9
- GitHub Security Advisories: https://github.com/advisories/GHSA-5w7r-f4cg-rqq7
- GitHub Security Advisories: https://github.com/advisories/GHSA-62f5-cp2p-vq95
- GitHub Security Advisories: https://github.com/advisories/GHSA-63mc-hw7g-86rr
- GitHub Security Advisories: https://github.com/advisories/GHSA-66r2-5gwj-gxm2
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-6v2g-fpxh-pmmh
- GitHub Security Advisories: https://github.com/advisories/GHSA-7hm9-v7vf-7g4w
- GitHub Security Advisories: https://github.com/advisories/GHSA-7j5w-7r7x-9v27
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-848m-r628-vrxw
- GitHub Security Advisories: https://github.com/advisories/GHSA-8737-qx52-hjff
- GitHub Security Advisories: https://github.com/advisories/GHSA-8x84-r2ff-h8pq
- GitHub Security Advisories: https://github.com/advisories/GHSA-c6mw-8xh8-gpq6
- GitHub Security Advisories: https://github.com/advisories/GHSA-f2rw-w22v-54vh
- GitHub Security Advisories: https://github.com/advisories/GHSA-fgmr-7w36-9qfq
- GitHub Security Advisories: https://github.com/advisories/GHSA-fph3-ghq9-vw66
- GitHub Security Advisories: https://github.com/advisories/GHSA-g29h-pfmp-qp9r
- GitHub Security Advisories: https://github.com/advisories/GHSA-gx45-xrj5-g6c4
- GitHub Security Advisories: https://github.com/advisories/GHSA-h4v5-crx2-3cv4
- GitHub Security Advisories: https://github.com/advisories/GHSA-h539-c7r8-3xq4
- GitHub Security Advisories: https://github.com/advisories/GHSA-h6w7-xxcf-w2mq
- GitHub Security Advisories: https://github.com/advisories/GHSA-hwrm-c4cx-rf4j
- GitHub Security Advisories: https://github.com/advisories/GHSA-jv8v-xq2h-657v
- GitHub Security Advisories: https://github.com/advisories/GHSA-m3c3-78fh-w3w7
- GitHub Security Advisories: https://github.com/advisories/GHSA-mfrj-v65r-979c
- GitHub Security Advisories: https://github.com/advisories/GHSA-mp7r-57w4-5qm3
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-pr7f-p5mw-fc87
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-rh53-xvx2-j327
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-w7wx-5q49-r59w
- GitHub Security Advisories: https://github.com/advisories/GHSA-wgwx-479j-23vq
- GitHub Security Advisories: https://github.com/advisories/GHSA-wrj3-vj8c-784f
