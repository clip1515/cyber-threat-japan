...
- 実行日時: 2026-09-11 00:07:32 〜 2026-09-11 00:08:06 (run_id=12)
- 収集結果: 成功ソース 12 / 失敗ソース 5 / 新規 75件 / 更新 1897件
...
- **[Critical] CVE-2025-67039** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2025-67039)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2025-67039
- **[Critical] CVE-2026-28802** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2026-28802)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2026-28802
- **[Critical] CVE-2026-27606** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2026-27606)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2026-27606
- **[Critical] CVE-2020-14498** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2020-14498)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2020-14498
- **[High] [KEV] CVE-2026-67277: MikroTik RouterOS Missing Authentication for Critical Function Vulnerability** (Japan Risk Score: 35, ステータス: NEW, CVE: CVE-2026-67277)
  - 情報源: CISA Known Exploited Vulnerabilities Catalog — https://nvd.nist.gov/vuln/detail/CVE-2026-67277
- **[High] [KEV] CVE-2026-86060: MikroTik RouterOS Improper Neutralization of Argument Delimiters in a Command Vulnerability** (Japan Risk Score: 35, ステータス: NEW, CVE: CVE-2026-86060)
  - 情報源: CISA Known Exploited Vulnerabilities Catalog — https://nvd.nist.gov/vuln/detail/CVE-2026-86060
- **[High] @argos-ci/core: CI Branch Name OS Command Injection** (Japan Risk Score: 30, ステータス: NEW, CVE: CVE-2026-59960)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-4x45-gxvp-6283
- **[High] rclone: RC per-server auth-proxy bypass** (Japan Risk Score: 30, ステータス: NEW, CVE: CVE-2026-88044)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-p569-5gjg-9cmj
- **[High] Traefik entrypoint header-name sanitization bypassed via request trailers** (Japan Risk Score: 30, ステータス: NEW, CVE: CVE-2026-88004)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-v67p-phpq-fc8x
- **[High] Pimcore: SQL Injection in Custom Reports via Malicious Report Configuration** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-55416)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-23rh-xw42-fq82
- **[High] n8n: Expression Sandbox Escape via Shared Builtin Tampering and Code-Printer Injection Leads to Code Execution** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-86083)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-6xcw-7xm6-48c6
- **[High] Open WebUI: A user's session cookies are sent to tool servers configured for bearer authentication** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-87015)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-p78m-89r6-pgf7
- **[High] @jhb.software/payload-alt-text-plugin: Alt Text Endpoint Authorization Bypass via Payload Local API `overrideAccess` Omission** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-59965)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-4qpv-39hg-f7fx
- **[High] rclone: http backend forwards custom/auth headers to a different host on redirect** (Japan Risk Score: 10, ステータス: NEW, CVE: CVE-2026-88013)
  - 情報源: GitHub Security Advisories — https://github.com/advisories/GHSA-486v-q2wf-fp2r
- **[High] CVE-2026-2229** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2026-2229)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2026-2229
- **[High] CVE-2026-1528** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2026-1528)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2026-1528
- **[High] CVE-2026-1526** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2026-1526)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2026-1526
- **[High] CVE-2026-32141** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2026-32141)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2026-32141
- **[High] CVE-2025-67041** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2025-67041)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2025-67041
- **[High] CVE-2025-67037** (Japan Risk Score: 0, ステータス: NEW, CVE: CVE-2025-67037)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2025-67037

(他 55 件、ダッシュボードで確認してください)
...
- **[Critical] CVE-2025-70141** (Japan Risk Score: 0, ステータス: MITIGATED, CVE: CVE-2025-70141)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2025-70141
- **[Critical] CVE-2025-61140** (Japan Risk Score: 0, ステータス: ACTIVE, CVE: CVE-2025-61140)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2025-61140
- **[Critical] CVE-2026-22797** (Japan Risk Score: 0, ステータス: ACTIVE, CVE: CVE-2026-22797)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2026-22797
- **[Critical] CVE-2025-12543** (Japan Risk Score: 0, ステータス: ACTIVE, CVE: CVE-2025-12543)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2025-12543
...
- **[Critical] CVE-2025-54603** (Japan Risk Score: 0, ステータス: ACTIVE, CVE: CVE-2025-54603)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2025-54603
- **[Critical] CVE-2024-28056** (Japan Risk Score: 0, ステータス: ACTIVE, CVE: CVE-2024-28056)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2024-28056
- **[Critical] CVE-2019-3773** (Japan Risk Score: 0, ステータス: ACTIVE, CVE: CVE-2019-3773)
  - 情報源: NVD CVE API 2.0 — https://nvd.nist.gov/vuln/detail/CVE-2019-3773
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-23rh-xw42-fq82
- GitHub Security Advisories: https://github.com/advisories/GHSA-2p48-j3qc-rx9f
- GitHub Security Advisories: https://github.com/advisories/GHSA-34ff-336r-5q23
- GitHub Security Advisories: https://github.com/advisories/GHSA-35jj-42hp-8gmq
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-65xw-2v52-jhxc
- GitHub Security Advisories: https://github.com/advisories/GHSA-66hp-wgxq-6f5q
- GitHub Security Advisories: https://github.com/advisories/GHSA-679f-58pq-4v2c
- GitHub Security Advisories: https://github.com/advisories/GHSA-6xcw-7xm6-48c6
- GitHub Security Advisories: https://github.com/advisories/GHSA-7ghq-v6jf-g56c
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-f2cp-m7mv-8jpv
- GitHub Security Advisories: https://github.com/advisories/GHSA-f52w-8j3h-j724
- GitHub Security Advisories: https://github.com/advisories/GHSA-f6mr-pjwc-34m4
- GitHub Security Advisories: https://github.com/advisories/GHSA-f8g7-2xjc-7mfh
- GitHub Security Advisories: https://github.com/advisories/GHSA-fmqh-xp37-5hr8
- GitHub Security Advisories: https://github.com/advisories/GHSA-hf57-cqmx-p4gr
- GitHub Security Advisories: https://github.com/advisories/GHSA-hh89-3r9w-qj3j
- GitHub Security Advisories: https://github.com/advisories/GHSA-hh8m-fm6v-7cvg
- GitHub Security Advisories: https://github.com/advisories/GHSA-hw8v-xxg5-vvvx
- GitHub Security Advisories: https://github.com/advisories/GHSA-j535-v25q-vx3q
- GitHub Security Advisories: https://github.com/advisories/GHSA-p297-fm68-3q8c
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-pcvc-8vrv-8q6w
...
- GitHub Security Advisories: https://github.com/advisories/GHSA-rf44-j88r-hh8c
- GitHub Security Advisories: https://github.com/advisories/GHSA-v39v-59xw-j98g
- GitHub Security Advisories: https://github.com/advisories/GHSA-v3p8-whq6-r5jg
...
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2025-12107
...
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2025-13818
...
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2025-13844
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2025-13845
...
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2026-0872
...
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2026-23111
...
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2026-2513
- NVD CVE API 2.0: https://nvd.nist.gov/vuln/detail/CVE-2026-2514
